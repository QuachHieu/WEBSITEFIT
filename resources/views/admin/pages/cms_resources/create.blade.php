            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <label>@lang('Phân loại') <small class="text-red">*</small></label>
                      <div class="form-control">
                        <label>
                          <input type="radio" name="phanloai" value="1" checked="">
                          <small>@lang('Công khai')</small>
                        </label>
                        <label>
                          <input type="radio" name="phanloai" value="2" class="ml-15">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="brief" class="form-control" rows="3">{{ old('brief') }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
