              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="@lang('Title')" value="{{ old('title') }}" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input id="image" class="form-control" type="text" name="image" placeholder="@lang('image_link')...">
                    </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" name="date_start" placeholder="@lang('ngày bắt đầu')" value="{{ old('date_start') }}">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>@lang('Ngày kết thúc')</label>
                    <input type="datetime-local" class="form-control" name="date_end" placeholder="@lang('ngày kết thúc')" value="{{ old('date_end') }}">
                  </div>
                </div>
